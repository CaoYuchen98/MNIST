...
for r=1:64  %原图512 * 512， 每行每列有 64 个 8
    for c=1:64
        B((r-1)*64+c, 1:8, 1:8) = Im( (r-1)*8+1:r*8 , (c-1)*8+1:c*8 );   %共64 * 64 = 4096个块
    end
end
